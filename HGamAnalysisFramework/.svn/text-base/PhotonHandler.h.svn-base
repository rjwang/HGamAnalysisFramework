...
namespace HG {
  ...
  private:
    ...
    egammaLayerRecalibTool               *m_layerCalibTool;
  ...
  public:
    static SG::AuxElement::Accessor<float> effSF, scaleFactor, isoSF;
    ...
    static SG::AuxElement::Accessor<float> etaS1, etaS2, cl_eta, cl_phi;
    static SG::AuxElement::Accessor<float> relEreso;
    static SG::AuxElement::Accessor<char> isLoose, isTight;
    static SG::AuxElement::Accessor<char> passOQ;
    static SG::AuxElement::Accessor<int>  conversionType;
    static SG::AuxElement::Accessor<float> conversionRadius;
  ...
  public:
    ...
    void decorateLayer(xAOD::Photon &gam);
    ...
    void decoratePID(xAOD::IParticle &part);
